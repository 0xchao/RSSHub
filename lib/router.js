...
// Hellosite
// CSSDesignAwards
router.get('/cssda/wotd', require('./routes/0feeeedin/cssda/wotd'));
router.get('/cssda/nominees', require('./routes/0feeeedin/cssda/nominees'));
router.get('/cssda/blog', require('./routes/0feeeedin/cssda/blog'));

// 腾讯
router.get('/tencent/isux', require('./routes/0feeeedin/tencent/isux'));
router.get('/tencent/cdc', require('./routes/0feeeedin/tencent/cdc'));
router.get('/tencent/tgideas', require('./routes/0feeeedin/tencent/tgideas'));

// Awwwards
router.get('/awwwards/sitesoftheday', require('./routes/0feeeedin/awwwards/sitesoftheday'));
router.get('/awwwards/blog', require('./routes/0feeeedin/awwwards/blog'));

// topys
router.get('/topyscn/articles', require('./routes/0feeeedin/topyscn/articles'));

// digitaling
router.get('/digitaling/articles', require('./routes/0feeeedin/digitaling/articles'));
router.get('/digitaling/projects', require('./routes/0feeeedin/digitaling/projects'));

// abduzeedo
router.get('/abduzeedo/articles', require('./routes/0feeeedin/abduzeedo/articles'));

// arting365
router.get('/arting365/articles', require('./routes/0feeeedin/arting365/articles'));
router.get('/arting365/:id', require('./routes/0feeeedin/arting365/category'));

// ad518
router.get('/ad518/creative', require('./routes/0feeeedin/ad518/creative'));
router.get('/ad518/news', require('./routes/0feeeedin/ad518/news'));

// behance
router.get('/behance/featured', require('./routes/0feeeedin/behance/featured'));

// hoverstates
router.get('/hoverstates/web', require('./routes/0feeeedin/hoverstates/web'));

// httpster
router.get('/httpster/web', require('./routes/0feeeedin/httpster/web'));

// uijar
router.get('/uijar/web', require('./routes/0feeeedin/uijar/web'));

// zcoolcn
router.get('/zcoolcn/recommend/:type', require('./routes/0feeeedin/zcoolcn/recommend'));

// uicn
router.get('/uicn/article', require('./routes/0feeeedin/uicn/article'));

// growthdesign
router.get('/growthdesign/casestudies', require('./routes/0feeeedin/growthdesign/casestudies'));

// figma
router.get('/figma/blog', require('./routes/0feeeedin/figma/blog'));

// adobe
router.get('/adobe/xd', require('./routes/0feeeedin/adobe/xd'));

// framer
router.get('/framer/blog', require('./routes/0feeeedin/framer/blog'));

// webflow
router.get('/webflow/blog', require('./routes/0feeeedin/webflow/blog'));

// ueno
router.get('/ueno/news', require('./routes/0feeeedin/ueno/news'));

// ndc
router.get('/ndc/works', require('./routes/0feeeedin/ndc/works'));

// nendo
router.get('/nendo/works', require('./routes/0feeeedin/nendo/works'));

// designmodo
router.get('/designmodo/articles', require('./routes/0feeeedin/designmodo/articles'));

// DESKmag
router.get('/DESKmag/blog', require('./routes/0feeeedin/DESKmag/blog'));

// gooood
router.get('/gooood/articles', require('./routes/0feeeedin/gooood/articles'));

// adstyle
router.get('/adstyle/articles', require('./routes/0feeeedin/adstyle/articles'));

// dezeen
router.get('/dezeen/magazine', require('./routes/0feeeedin/dezeen/magazine'));

// wallpaper*
router.get('/wallpaper*/magazine', require('./routes/0feeeedin/wallpaper*/magazine'));

// voicer
router.get('/voicer/articles', require('./routes/0feeeedin/voicer/articles'));

// minimalissimo
router.get('/minimalissimo/articles', require('./routes/0feeeedin/minimalissimo/articles'));

// yixi
router.get('/yixi/speech', require('./routes/0feeeedin/yixi/speech'));

// ted
router.get('/ted/en', require('./routes/0feeeedin/ted/en'));
router.get('/ted/cn', require('./routes/0feeeedin/ted/cn'));

// uncrate
router.get('/uncrate/articles', require('./routes/0feeeedin/uncrate/articles'));

// ableton
router.get('/ableton/blog', require('./routes/0feeeedin/ableton/blog'));

// booooooom
router.get('/booooooom/articles', require('./routes/0feeeedin/booooooom/articles'));

// creativeboom
router.get('/creativeboom/articles', require('./routes/0feeeedin/creativeboom/articles'));

// typographic
router.get('/typographic/posters', require('./routes/0feeeedin/typographic/posters'));

// informationisbeautiful
router.get('/informationisbeautiful/articles', require('./routes/0feeeedin/informationisbeautiful/articles'));
router.get('/informationisbeautiful/beautifulnews', require('./routes/0feeeedin/informationisbeautiful/beautifulnews'));

// sgustok
router.get('/sgustok/design', require('./routes/0feeeedin/sgustok/design'));

// thetype
router.get('/thetype/blog', require('./routes/0feeeedin/thetype/blog'));

// gtn9
router.get('/gtn9/projects', require('./routes/0feeeedin/gtn9/projects'));

// eyeondesign
router.get('/eyeondesign/articles', require('./routes/0feeeedin/eyeondesign/articles'));

// itsnicethat
router.get('/itsnicethat/articles', require('./routes/0feeeedin/itsnicethat/articles'));

// airbnb
router.get('/airbnb/design', require('./routes/0feeeedin/airbnb/design'));

// uisdc
router.get('/uisdc/articles', require('./routes/0feeeedin/uisdc/articles'));

// casestudyclub
router.get('/casestudyclub/articles', require('./routes/0feeeedin/casestudyclub/articles'));

// psdrepo
router.get('/psdrepo/articles', require('./routes/0feeeedin/psdrepo/articles'));

// sketchrepo
router.get('/sketchrepo/articles', require('./routes/0feeeedin/sketchrepo/articles'));

// mana
router.get('/mana/explorevideo', require('./routes/0feeeedin/mana/explorevideo'));
router.get('/mana/activity', require('./routes/0feeeedin/mana/activity'));

// frieze
router.get('/frieze/magazine', require('./routes/0feeeedin/frieze/magazine'));

// ideat
router.get('/ideat/articles', require('./routes/0feeeedin/ideat/articles'));

// spectacle
router.get('/spectacle/video', require('./routes/0feeeedin/spectacle/video'));

// tubik
router.get('/tubik/blog', require('./routes/0feeeedin/tubik/blog'));

// facebook
router.get('/facebook/design', require('./routes/0feeeedin/facebook/design'));

// spotify
router.get('/spotify/design', require('./routes/0feeeedin/spotify/design'));

// nationalgeographic
router.get('/nationalgeographic/stories', require('./routes/0feeeedin/nationalgeographic/stories'));

// pmcaffcom
router.get('/pmcaffcom/articles', require('./routes/0feeeedin/pmcaffcom/articles'));
