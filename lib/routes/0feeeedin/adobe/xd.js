...
module.exports = async (ctx) => {
    ...
    for (let i = 0; i < responses.length; i++) {
        ...
        let time = $('.post-author-info .post-date').text();
        ...
        let category = $('.article-breadcrumbs').text();
        out[indexList[i]].category = category;
        let author = $('.post-author-info .post-author').text();
